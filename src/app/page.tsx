...
const Home = () => {
      ...
      <section id="Home" className="scroll-mt-52 px-6 flex flex-col md:flex-row gap-10 md:gap-20 md:justify-center md:items-center p-2 md:px-16 mb-12 md:mb-48 lg:mb-56 lg:pt-16">
        ...
        <div className="flex flex-col items-start gap-2 md:mt-16 md:w-1/2">
          <div>
            ...
            <h1 className={`${dancingScript.className} text-5xl text-[#1976D2]`}>Sonja Kitanoska</h1> 
          </div>
          <p className="">
 ...
 {/* about me */}
      ...
      <section id="About" className="scroll-mt-24 p-6 md:p-24 md:mb-24 mb-6 bg-blue-200/90">
